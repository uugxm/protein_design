...
REFERENCE_PDB="${REFERENCE_PDB:-$BASE/examples/rsv_f_siteV_hRSV90_reproduction_5TPN_20260629/inputs/5TPN_cleaned.pdb}"
MOTIF_TSV="${MOTIF_TSV:-$BASE/examples/rsv_f_siteV_hRSV90_reproduction_5TPN_20260629/inputs/motif_residues_benchmark.tsv}"
