...
against the experimental `rfdiffusion_all_atom` backend using the same downstream
...
rfdiffusion_all_atom backbone generation: 123191, COMPLETED, 00:21:28, gpu15
rfdiffusion_all_atom ProteinMPNN array: 123192, 10/10 completed
rfdiffusion_all_atom AF3 array: 123193, 9/10 first-pass completed
rfdiffusion_all_atom failed AF3 task: 123193_6, retried as 123254_6, COMPLETED
rfdiffusion_all_atom retry filter: 123255_6, COMPLETED
rfdiffusion_all_atom retry merge: 123256, COMPLETED
...
rfdiffusion_all_atom/reports/all_filter_summary.csv
rfdiffusion_all_atom/reports/top_designs.csv
rfdiffusion_all_atom/reports/run_report.json
job_ids.env
rfdiffusion_v1/job_ids.env
rfdiffusion_all_atom/job_ids.env
logs/
```
