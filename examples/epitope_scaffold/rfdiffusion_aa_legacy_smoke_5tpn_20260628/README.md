...
`rfdiffusion_all_atom_legacy` smoke test in the protein design stack.

## Run

```text
Cluster run directory: /public/home/yinyifan/protein_design/examples/epitope_scaffold/rfdiffusion_all_atom_legacy_smoke_5tpn_20260628_194145
Slurm job: 123174
Node: gpu14
State: COMPLETED
Elapsed: 00:01:52
